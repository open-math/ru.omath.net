...
@term
    title: Высказывание
    main: |
        Предложение, в котором что-то утверждается.
...
{ #proposition-value +toc }
@term
    title: Истинностное значение
    main: |
        Значение свойства высказывания быть истинным или ложным.
...
{ #proposition-form +toc }
@term
    title: Высказывательная форма
    main: |
        Предложение с переменными, в котором что-то утверждается.
...
@important
    ...
    main: |
        ...
        Так как у нас нет полного предложения, которое что-то утверждает, то мы не можем сказать, истино оно или ложно. Именно поэтому высказывательная форма не истинна и не ложна — для нее эти понятия **неприменимы**{ accent }.
