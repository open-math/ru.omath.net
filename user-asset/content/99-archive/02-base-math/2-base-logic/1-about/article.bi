...
@term
    title: Логика
    main: |
        Наука о законах, принципах и методах рассуждений.
...
@term
    ...
    main: |
        Раздел логики, в котором законы, принципы и методы рассуждений формируются с математической строгостью с использованием языка математической логики.
...
В математической логике используется **язык математической логики**. Это [математический язык](article|../../lang-of-math/math-lang|math-lang).
