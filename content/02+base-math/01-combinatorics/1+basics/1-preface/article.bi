Начнём изучение комбинаторики на позитивной ноте, с анекдота, который отлично иллюстрирует суть этого замечательного, интересного и очень полезного раздела математики:
...
@callout
    ...
    content: |
        ...
        А в то время и студенты, и профессора были бедные, домой их не отправишь, пришлось спать укладывать в профессорской трёхкомнатной квартире.
        ...
        Не спится и профессору. Встаёт среди ночи, дай, думает, пойду посмотрю, как там дочка, мало ли что от этих балбесов ждать. Шнырь в одну комнату, две головы, - ага, студенты, шнырь в другую - одна. Дочка, не иначе. Прыг - спит.
...
{ #combinatorics +toc link }
@term
    title: Комбинаторика
    main: |
        { text-left }
        Раздел математики, в котором изучаются закономерности составления комбинаций из различных объектов.
...
На этапе планирования вы будете пытаться найти самый короткий или дешёвый маршрут -- комбинацию городов, которые надо посетить.
...
Для ответа на этот вопрос нужно знать, сколько вообще комбинаций придётся перебрать.
...
@important
    ...
    main: |
        ...
        3. Подсчёт количества комбинаций.
...
Важно ещё и чётко обозначить, чем комбинаторика **не занимается**.
Ещё раз обратите внимание на определение, а конкретно на слова *"изучаются закономерности составления комбинаций"*.
Зачем так сложно?
...
@important
    ...
    main: |
        Нас не интересует, какой **не**{ accent }математический смысл стоит за комбинациями.\
        Комбинаторика рассматривает только вопросы, связанные с **составлением**{ accent } комбинаций!

# Зачем изучать комбинаторику?

Вы заметили, что приведённые ранее примеры и аналогии всем нам очень хорошо знакомы: слова, путешествия, распорядок дня, телефонные номера? Это не случайность.
...
Чтобы не проиграть своё состояние, игроки внимательно следили за процессом игры, анализировали его, искали выигрышные стратегии.
...
Каждая такая проблема по сути связана с построением комбинаций по чётко заданным правилам.
