~ bf-rules article|brute-force-rules

@problems
    title: Орел или решка?
    level: easy
    shared: |
        Подбрасывание монетки, что может быть проще?!
    set:
        -   description: |
            ...
            answer: |
                ...
                @math
                    ...
                    \begin{array}{c|c|c|c|c}
                        \text{0 орлов} & \text{1 орел} & \text{2 орла} & \text{3 орла} & \text{4 орла} \\\hline
...
@problems
    ...
    level: easy
    shared: Куда же в комбинаторике и без задач на броски кубиков?
    set:
        -   description: |
...
@problem
    ...
    hints:
        - Разбейте все трезначные числа на группы по первой цифре.
        - Внутри каждой группы перечисление чисел проводите по возрастанию.
    solution: |
        ...
        Всего мы нашли $28$ трехзначных чисел, сумма цифр которых равна $7$.
    answer: |
        Всего $28$ чисел:
...
@todo
    title: Больше задач нормального уровня сложности!
    content: |
        Задачи из "[Перебор вариантов](https://mathus.ru/math/kombinatorika.pdf)"
...
@problem
    ...
    answer: |
        $8$
    note: |
        Из задачи следует интересный факт -- **любые числа** с двумя разными нетривиальными делителями являются либо произведением двух простых чисел, либо кубами простых чисел.
...
@problems
    ...
    set:
        -   label: Образец
            ...
            solution:
                ...
                "Решение через системы счисления": |
                    ...
                    [Переводим](transform-to-three) это число в троичную систему:
                ...
                "Решение напрямую": |
                    ...
                    Замечаем, что номера замены с буквой "А" делятся нацело на $3$: $0/3, 3/3, \ldots$\
                    Номера замены с буквой "Б" при делении на $3$ дают остаток $1$: $1/3, 4/3, \ldots$\
                    Наконец, номера замены с буквой "В" при делении на $3$ дают остаток $2$: $2/3, 5/3, \ldots$\
        ...
        -   label: Отработка
            generator: generators/dictionary
            description: |
                Елена составила список всех ${{ wordLength }}$-буквенных слов, которые можно составить из букв {{ allowedLetters }}.
                ...
                Запишите слово, которое стоит на ${{ targetPos }}$-м месте в этом списке.
            answer: |
                На ${{ targetPos }}$-м месте в списке стоит слово "{{ targetWord }}".
...
@problems
    ...
    set:
        -   label: Образец
            ...
            solution:
                "": |
                    Решить эту задачу можно двумя способами, как и задачу [Пятибуквенный словарь](dictionary): через системы счисления и напрямую.
        ...
        -   label: Отработка
            ...
            description: |
                ...
                На каком месте в этом списке стоит слово "{{ targetWord }}"?
            answer: |
                Слово "{{ targetWord }}" стоит на ${{ targetPos }}$-м месте.
