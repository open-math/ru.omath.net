...
@problem
    ...
    solution:
        ...
        "С красной полоской": |
            ...
            Если красная полоска сверху, то имеем $4$ цвета для центральной полоски и $4$ цвета для нижней полоски (не пять, потому что цвет нижней не должен совпадать с цветом центральной).
            ...
            Эти группы не пересекаются, потому что в каждой группе красная полоска на своем, уникальном месте.
            Поэтому мы можем использовать правило суммы для того, чтобы найти количество всех флагов с красной полоской:

            $$ 16 + 16 + 16 = 48 $$
    answer: |
        Всего $60$ флагов с различными цветами, $20$ флагов с повторяющимися цветами и $48$ флагов с красной полоской.
