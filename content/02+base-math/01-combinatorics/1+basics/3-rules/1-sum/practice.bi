...
@problems
    ...
    set:
        ...
        -   description: |
            ...
            solution: |
                Считаем количество нечетных карт.
                Карт с цифрой "1" нет, поэтому из нечетных остаются числа $3$, $5$, $7$ и $9$ -- всего $4$ карты по $4$ масти равно $16$ карт нечетных карт.

                Красных по-прежнему $26$ из них $4\cdot 2 = 8$ красных карт с нечеными цифрами образуют пересечения.

                Всего "нечетных или красных" получается $16 + 26 - 8 = 34$ штуки.
                ...
                Пересечений с "четными или красными" нет, поэтому по [правилу суммы](~sumRule) находим $34 + 6 = 40$ подходящих карт.
            answer: $40$
