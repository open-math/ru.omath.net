    ...
    set:
        ...
        -   description: |
            ...
            solution: |
                ...
                Карт с цифрой "1" нет, поэтому из нечетных остаются числа $3$, $5$, $7$ и $9$ -- всего $4$ карты по $4$ масти равно $16$ нечетных карт.
                ...
                Пересечений с "нечетными или красными" нет, поэтому по [правилу суммы](~sumRule) находим $34 + 6 = 40$ подходящих карт.
            answer: $40$
