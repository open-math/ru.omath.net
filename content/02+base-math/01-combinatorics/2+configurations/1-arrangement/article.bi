...
{ #a-repeat-formula +toc link }
@statement
    title: Формула размещений с повторениями
    main: |
        $$ \bar{A}^k_n = n^k $$
    sections:
        proof: |
...
{ #a-unique-formula +toc link }
@statement
    title: Формула размещений без повторений
    main: |
...
{ #a-unique-factorial-formula +toc link="Размещения без повторений через факториал" }
@statement
    title: Формула размещений без повторений через факториал
    main: |
        $$ A^k_n = \frac{n!}{(n-k)!} $$
    sections:
        proof: |
