...
@term
    title: Умножение
    main: |
        **Умножить**{ accent } число $a$ на число $b$ -- взять число $a$ и сложить с самим собой $b$ раз.
...
@term
    title: Деление
    main: |
        **Поделить**{ accent } число $a$ на число $b$ -- найти число раз, которое надо сложить $b$ с самим собой, чтобы получить $a$.
...
@important
    title: Деление ненулевого числа на 0
    main: |
        Попытаться поделить **любое ненулевое**{ accent } число $a$ на $0$ можно, но **ответа просто нет**{ accent }.
