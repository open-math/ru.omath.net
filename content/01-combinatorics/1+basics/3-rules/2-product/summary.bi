@diagram
    graph TD
        root[Базовый подсчет комбинаций] -->|Разбить на группы и сложить| sumRule[Правило суммы]
        root -->|Последовательно выбирать элементы| productRule[Правило произведения]
        class root fill

---

<~ article|rule-of-product
...
<~ article|generic-rule-of-product

<~ article|different-heroes

<~ article|how-many-words

---

<~ article|rule-of-product-usage